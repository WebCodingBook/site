...
return [
    ...
    */
    ...
    'providers' => [
         ...
         */
        WebCoding\Providers\AppServiceProvider::class,
        WebCoding\Providers\AuthServiceProvider::class,
        WebCoding\Providers\EventServiceProvider::class,
